	...
	<div class="hoofd_menu">
		<div class="container">
			<div class="row d-flex align-items-center">
				<div class="col-2 col-md-1 d-lg-none d-md-block">
					<div class="h_button">
						<span></span>
						<span></span>
						<span></span>
				...
				<div class="branding col-lg-2 col-md-10 col-8 d-flex justify-content-lg-start justify-content-md-center justify-content-center">
				...
				<div class="col-md-1 col-2 winkelmand">
